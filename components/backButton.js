...
AFRAME.registerComponent('back-button', {
  ...
  init() {
    const html = `
    <a-entity mixin="button" geometry="primitive:  plane;  width:  1.8;  height:  0.3"  material="color:#CCC" goto="https://screeeen.github.io/vr-sandbox/index.html"  position="0 .24 -4"
